      ...
      <div className="container" style={{ margin: 0, padding: 0, display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
        ...
        <div className="login-box" style={{ flex: 1, padding: '2rem' }}>
          ...
          <form onSubmit={this.handleSubmit}>
            <label htmlFor="username" className="label">이름</label><br />
            <input
              type="text"
              id="username"
              name="username"
              ...
              required
            /><br />
            <label htmlFor="email" className="label">이메일</label><br />
            <input
              type="text"
              id="username"
              name="username"
              ...
              required
            /><br />
            <label htmlFor="password" className="label">비밀번호</label><br />
            <input
              type="password"
              id="password"
              name="password"
